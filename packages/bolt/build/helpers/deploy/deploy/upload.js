...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "fs", "../../../config", "../apis/handlers/gql", "@gluestack/glue-server-sdk-js", "../apis/handlers/gql/create-deployment"], factory);
    }
    ...
    const upload = (filepath, store) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            console.log("> Failed to create deployment:", error.response.errors || error);
        }
        // unlinkSync(filepath);
    });
