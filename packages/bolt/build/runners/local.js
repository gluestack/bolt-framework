...
(function (factory) {
    ...
    class Local {
        ...
        static start(servicePath, build, serviceName) {
            return __awaiter(this, void 0, void 0, function* () {
                const local = new Local(servicePath, build);
                return yield local.run(serviceName);
            });
        }
        ...
        static logs(serviceName, servicePath, isFollow) {
            return __awaiter(this, void 0, void 0, function* () {
                yield (0, get_local_logs_1.getLogs)(serviceName, servicePath, isFollow, (0, path_1.join)(".logs", serviceName));
            });
        }
    }
