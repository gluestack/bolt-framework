...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "path", "chalk", "adm-zip", "../helpers/exit-with-msg", "../helpers/fs-exists", "../helpers/update-store", "../helpers/validate-seal-file", "../helpers/get-ssh-port", "../helpers/fs-remove-folder", "../helpers/fs-mkdir", "../helpers/download-base-image", "../helpers/fs-removefile", "../helpers/validate-project-status", "../helpers/execute", "../libraries/container", "../runners/vm", "../constants"], factory);
    }
    ...
    exports.default = (localPath, option) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const cached = option.cache || false;
            ...
            const project = yield (0, validate_project_status_1.validateProjectStatus)(sealvmConfig.projectId, "create", sealvmConfig);
            // Getting ssh port
            const sshPort = yield (0, get_ssh_port_1.getSSHPort)();
            // Create Images for the project
            const container = new container_1.default(`${sealvmConfig.projectId}_${sealvmConfig.name}`);
            const contianerPath = yield container.createImage(cached);
            // Boot up VM
            ...
            const json = Object.assign(Object.assign({}, project), { containerPath: contianerPath, sshPort: sshPort, status: "build", vmProcessId: vmPid, 
                // mountProcessId: mountPid,
                createdAt: Date.now(), updatedAt: Date.now() });
            yield (0, update_store_1.updateStore)("projects", sealvmConfig.projectId, json);
        }
        catch (err) {
            console.log(err);
