...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../package.json", "chalk", "lodash", "path", "commander", "fs/promises", "closest-match"], factory);
    }
    ...
    class Commander {
        ...
        init() {
            return __awaiter(this, void 0, void 0, function* () {
                this.program
                    .name("sealvm")
                    .version(`sealvm Run Version v${package_json_1.default.version}`)
                    .description(`sealvm CLI tool v${package_json_1.default.version}`);
            });
        }
        addCommands() {
            var _a, e_1, _b, _c;
