...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "os", "path", "chalk", "../helpers/fs-exists", "../helpers/fs-mkdir", "../helpers/fs-copyfile", "../helpers/exit-with-msg", "../helpers/fs-remove-folder", "../constants"], factory);
    }
        ...
        createImage(cached) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (!cached) {
                    ...
                    yield (0, fs_copyfile_1.copyFile)(constants_1.VM_BINARIES.ALPINE, projectContainerPath, constants_1.VM_BINARIES.CONTAINER_IMAGE_NAME);
                    console.log(chalk_1.default.green(`>> Image created for ${this.containerName}!`));
                }
                if (!(yield (0, fs_exists_1.exists)((0, path_1.join)(projectContainerPath, constants_1.VM_BINARIES.CONTAINER_IMAGE_NAME)))) {
