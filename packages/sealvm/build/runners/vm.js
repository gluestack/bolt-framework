...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "chalk", "../constants/vm-commands", "../helpers/connect-to-vm", "../helpers/execute-detached", "../helpers/kill-process"], factory);
    }
    ...
    class Vm {
        ...
        boot() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return (0, execute_detached_1.executeDetachedWithLogs)("qemu-system-aarch64", args, this.projectPath, {
                    shell: true,
                });
            });
        }
