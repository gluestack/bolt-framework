    ...
    function runProjectInsideVm(projectConfig, isDetatched) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (isDetatched) {
                ...
                return yield (0, execute_detached_1.executeDetachedWithLogs)("ssh", args, (0, path_1.join)(projectConfig.source, `.sealvm.${projectConfig.name}.info`), {
                    shell: true,
                    detached: true,
                });
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!(yield (0, fs_exists_1.exists)(localPath))) {
                    (0, exit_with_msg_1.exitWithMsg)(">> Please specify correct path to run the project");
                    return;
                }
                ...
                process.on("SIGINT", () => {
                    (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield (0, update_store_1.updateStore)("projects", sealConfig.name, Object.assign(Object.assign({}, project), { status: "build", sshProcessIds: null, projectRunnerId: null }));
                        process.exit(0);
                    }))();
                });
            }
